    ...
    <div class="col-lg-9"> 
      <div class="card text-center">
        <div class="card-header">
          <p class="display-4 titre">Rechercher Vente<span class="badge badge-secondary">Rechercher</span></p>
        </div>
      </div>
        <!--Eto aho-  -->
        <form class="row g-3 needs-validation" novalidate action="" method="GET">
          ...
          <div class="col-6">
            <button class="btn btn-primary" name="page" value="affichage.acheter" type="submit">Rechercher</button>
          </div>
        </form>

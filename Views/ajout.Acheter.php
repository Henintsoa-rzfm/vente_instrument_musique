    ...
    <div class="col-lg-9"> 
      <div class="card text-center">
        <div class="card-header">
          <p class="display-4 titre">Saisie Vente<span class="badge badge-secondary">Nouveau</span></p>
        </div>
      </div>
        <!--Eto aho-  -->
        <form class="row g-3 needs-validation" novalidate action="" method="POST">
          ...
          <div class="col-md-6">
            ...
            <select class="form-select" id="NumAchat" name="NumAchat" required>
              <?php
                $achet = \Models\Achat::showAll("NumAchat");
                foreach($achet as $ach):
                  extract($ach);
              ?>
          ...
          <div class="col-md-6">
            ...
            <select class="form-select" id="taille" name="RefClt" required>
              <?php
...
if(isset($_POST['Enregistrer'])){
  \Controllers\Acheter::insert($_POST);
  // print_r($_POST);
}
?>
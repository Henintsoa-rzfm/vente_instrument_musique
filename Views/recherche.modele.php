    ...
    <div class="col-lg-9"> 
      <div class="card text-center">
        <div class="card-header">
          <p class="display-4 titre">Rechercher Modele<span class="badge badge-secondary">Rechercher</span></p>
        </div>
      </div>
        <!--Eto aho-  -->
        ...
        <div class="col-md-6">
          ...
          <div class="col-6">
            <button class="btn btn-primary" value="affichage.modele" name="page" type="submit">Rechercher</button>
          </div>
        </form>
        </form>

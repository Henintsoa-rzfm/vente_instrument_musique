...
$Acheter = \Models\Acheter::find($_GET);
$listesAcheter = \Models\Acheter::find($_GET);
    ...
    <div class="col-lg-3 bg-dark">
      ...
      <div class="bouton1">
        <form action="" method="GET">
          ...
          <button type="submit" class="btn btn-danger btn-lg">Rechercher</button><br><br>
    ...
    <div class="col-lg-9"> 
      <div class="card text-center">
        <div class="card-header">
          <p class="display-4 titre">Résultats Recherche des Ventes<span class="badge badge-secondary">ITT</span></p>
        </div>
      </div>
        <table class="table table-success table-striped table-hover">
          ...
          <tbody>
            <tr>
              <?php
                foreach($Acheter as $acheter):
                extract($acheter);
              ?>
              <th scope="row"><a href="#" class="lien"><?php echo $NumAchat?></a></th>
              <td><a href="#" class="lien"><?php echo $RefClt?></a></td>

    ...
    <div class="col-lg-9"> 
      <div class="card text-center">
        <div class="card-header">
          <p class="display-4 titre">Rechercher<span class="badge badge-secondary">Modifier</span></p>
        </div>
      </div>
        <!--Eto aho-  -->
        ...
        <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="heureAchat" name="HeureAchat">
          </div>
          <div class="col-md-6">
          ...
          <div class="col-12">
            <button class="btn btn-primary" name="page" value="affichage.achat" type="submit">Rechercher</button>
          </div>
        </form>
